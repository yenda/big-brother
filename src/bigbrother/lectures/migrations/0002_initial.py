...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'lectures_teacher', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'lectures', ['Teacher'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'lectures_teacher')
    ...
    models = {
        ...
        u'lectures.lecture': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'teachers': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['users.User']", 'through': u"orm['lectures.Teacher']", 'symmetrical': 'False'})
        },
        u'lectures.teacher': {
